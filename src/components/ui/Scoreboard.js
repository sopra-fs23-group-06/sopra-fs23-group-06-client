                ...
                <div className="scoreboard-content">
                    ...
                    <div className='scoreboard-buttons'>
                        <div className='button-group'>
                            <ButtonPurpleMain onClick={handleClick}>
                                <div class="arrow left"></div>
                                Back</ButtonPurpleMain>
                            <ButtonPurpleMain onClick={() => handleLeaveGame()} disabled={recentRequest}>Leave <img
                                className="icon" src={leaveIcon} alt="Leave Icon" /></ButtonPurpleMain>
                        </div>
                    </div>
                </div>
            </div>
