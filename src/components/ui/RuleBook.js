    ...
    <div className= "rule-book-content">
        <h1>Objective of the Game</h1>
            <p>
                ...
                Then the objective is to fulfil that bid... <br/><div style={{ marginBottom: '0.8em' }}></div>
                Anyone who fails to fulfil their bid because they win too many or too few tricks loses glory and fame.
                It can be very lucrative to make a no-tricks bid. But it is also very risky... <br/><div style={{ marginBottom: '0.8em' }}></div>
        ...
        <h1>Game Settings</h1>
        <p>
            The host of the game can choose the number of hands dealt and the maximum number of players in the Game settings menu in the lobby.
        ...
        <h1>Setup</h1>
            <p>
                ...
                In the first hand each player receives only 1 card, in the second hand 2 cards and continuing until the last hand is dealt.
                Throughout the game, as many rounds are played as the players are holding cards in their hands.
                <br/><div style={{ marginBottom: '0.8em' }}></div>
                <strong> Example:</strong> it would not be possible to win 5 tricks if you are holding 4 cards as there will only be four rounds.
            </p>
        <h1>Game Turn</h1>
            <p>
                ...
                <br/><div style={{ marginBottom: '0.8em' }}></div>
                <strong> Note:</strong> Anyone who thinks they are capable of winning more than five tricks stretches out five fingers, at the same time naming the number loud and clear.
                The bids for each player are noted down in the narrow column on the notepad.<br/><div style={{ marginBottom: '0.8em' }}></div>
                In this online version of the game, the players enter their bids before each round and the "YO - HO - HO" is done automatically
                by the game when all players have entered their bids. The bids are also recorded automatically on the scoreboard.
                ...
                Exception: The skull and crossbones flag (black) is the highest suit and it trumps all other suits (irrespective of its numerical value).
        ...
        <h1>Hewing and Stabbing</h1>
            <p>
                ...
                <br/><div style={{ marginBottom: '0.8em' }}></div>
                In this online version of the game, the number of tricks won by each player is recorded automatically on the scoreboard.
            </p>
        <h1>Special Cards</h1>
            <p>
                <h3>Escape Card</h3>
                <img src={require(`../../styles/images/cards/special/escape.png`)} alt="Escape Card" style={{ width: '22%', display: 'block', margin: '0 auto', borderRadius: '15px' }}></img>
                ...
                <h3>Mermaid Card</h3>
                <img src={require(`../../styles/images/cards/special/mermaid.png`)} alt="Mermaid Card" style={{ width: '22%', display: 'block', margin: '0 auto', borderRadius: '15px' }}></img>
                <div style={{ marginBottom: '1.2em' }}></div>
                ...
                <h3>Pirate Cards</h3>
                <img src={require(`../../styles/images/cards/special/badeye_joe.png`)} alt="Pirate Card" style={{ width: '22%', display: 'block', margin: '0 auto', borderRadius: '15px' }}></img>
                <div style={{ marginBottom: '1.2em' }}></div>
                ...
                <img src={require(`../../styles/images/cards/special/scary_mary_none.png`)} alt="Scary Mary Card" style={{ width: '22%', display: 'block', margin: '0 auto', borderRadius: '15px' }}></img>
                <div style={{ marginBottom: '1.2em' }}></div>
                ...
                If chosen as an Escape, only flags will be displayed in the corners, if chosen as a pirate, only skulls will be displayed.

                <h3> Skull King Card</h3>
                <img src={require(`../../styles/images/cards/special/skull_king.png`)} alt="Skull King Card" style={{ width: '22%', display: 'block', margin: '0 auto', borderRadius: '15px' }}></img>
                <div style={{ marginBottom: '1.2em' }}></div>
                The Skull King can only be trumped by a Mermaid.
                All other cards are lower than the Skull King.
                If there is a Pirate card in a trick which is won with the Skull King (the Scary Mary always counts as a pirate for this purpose, no matter how it is used), the player gets a bonus.
                <br/><div style={{ marginBottom: '0.8em' }}></div>
                Again, as a reminder: Special cards can be played at any time! Even if it is possible to follow suit!
                <br/><div style={{ marginBottom: '1.3em' }}></div>
                <strong>Notes:</strong>
                <br/><div style={{ marginBottom: '0.6em' }}></div>
        ...
        <h1>Scoring</h1>
            <p>
                A player who bids their number of tricks correctly receives 20 points per trick that they have won.<br/><div style={{ marginBottom: '0.4em' }}></div>
                <strong> Example:</strong> David bids 3 tricks which he indeed gets. He receives a total of 60 points.
                <br/><div style={{ marginBottom: '1.2em' }}></div>
                A player who wins more or fewer tricks than bid, receives no plus points and no bonus points.
                They receive 10 minus points for each trick more or less than their bid.<br/><div style={{ marginBottom: '0.4em' }}></div>
                <strong> Example:</strong> Simon bids 5 tricks but only wins 1 trick. The difference is 4 tricks. So he gets 40 minus points.
                <br/><div style={{ marginBottom: '1.2em' }}></div>
                ...
                <br/><div style={{ marginBottom: '0.4em' }}></div>
                <strong> Example:</strong> In round 4 Eloise makes a bid to win no tricks. At the end of the round she has actually managed not to win any tricks.
                ...
                <br/><div style={{ marginBottom: '0.4em' }}></div>
                <strong> Example:</strong> In round 9 David makes a bid to win no tricks. But in the course of the round he had to take two tricks.
